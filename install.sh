...
do_install() {
        ...
        case "$lsb_dist" in
                ...
                ubuntu|debian)
                        ...
                        (
                        set -x
                        $sh_c "apt-key adv --keyserver-options http-proxy=http://child-prc.intel.com:912 --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 58118E89F3A912897C070ADBF76221572C52609D"
